...
public class APIGatewayAuthorizerHandler implements RequestHandler<TokenAuthorizerContext, AuthPolicy> {
	...
	private static final Logger LOG = LogManager.getLogger(APIGatewayAuthorizerHandler.class);
    ...
    public AuthPolicy handleRequest(TokenAuthorizerContext input, Context context) {
    	...
    	if (token.equalsIgnoreCase("TAM|12345678")
				|| token.equalsIgnoreCase("AVIANCA|87654321")) {
